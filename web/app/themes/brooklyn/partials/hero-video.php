...
<!-- hero section -->
<section id="ut-hero" class="<?php echo (!empty($ut_video_source) && $ut_video_source == 'custom') ? 'ut-single-video' : ''; ?> hero ha-waypoint parallax-section parallax-background <?php echo $ut_hero_width; ?>" data-animate-up="ha-header-hide" data-animate-down="ha-header-hide">
