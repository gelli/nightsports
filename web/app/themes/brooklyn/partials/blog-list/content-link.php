    ...
    <div class="grid-100 tablet-grid-100 mobile-grid-100">
        ...
        <?php if( get_the_title() ) :?>
            ...
            <header class="entry-header clearfix">
                ...
                <h2 class="entry-title"><a title="<?php echo esc_attr( wp_strip_all_tags( get_the_title() ) ); ?>" href="<?php echo esc_url( post_format_link_content() ); ?>" rel="bookmark"><?php the_title(); ?></a></h2>          
