<article id="post-<?php the_ID(); ?>" <?php post_class( 'clearfix' ); ?>>
    ...
    <div class="grid-45 tablet-grid-100 mobile-grid-100">
        ...
        <?php if ( get_post_format_audio_content() && ! post_password_required() ) : ?>
    ...
    <div class="<?php echo get_post_format_audio_content() ? 'grid-55 ut-blog-list-content' : 'grid-100'; ?> tablet-grid-100 mobile-grid-100">
