...
if ( ! function_exists( 'unite_scripts' ) ) {
    ...
    function unite_scripts() {
        ...
        if( ot_get_option( 'ut_smooth_scroll' , 'on' ) == 'on' && isset( $_SERVER['HTTP_USER_AGENT'] ) && preg_match("/chrome/",strtolower($_SERVER['HTTP_USER_AGENT'])) && !unite_mobile_detection()->isMobile() ) {
