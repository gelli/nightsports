        ...
        public function custom_css() {
            ...
            <style id="ut-contact-section-css" type="text/css">
                ...
                if( $ut_csection_header_style == 'pt-style-2') {                
                    ...
                    $ut_csection_headline_style_2_color  = ot_get_option('ut_csection_headline_style_2_color', ot_get_option('ut_global_headline_style_2_color', '#222') );
                ...
                if( $ut_csection_header_style == 'global' ) {
                    ...
                    echo $this->section_headline_css( 
                        '#contact-section',
                        'pt-style-2', 
                        ot_get_option('ut_global_headline_style_2_color', '#222'),
                ...
                if( ot_get_option('ut_csection_title_uppercase' , 'off') == 'on' ) {
                    echo '#contact-section .parallax-title, #contact-section .section-title { text-transform: uppercase; }';
                }
                ...
                if( !empty( $ut_csection_header_expertise_slogan_color ) ) {
                    echo '#contact-section .lead { color: ' . $ut_csection_header_expertise_slogan_color . ' }'. "\n";
                }
                ...
                if( empty( $ut_csection_background_image ) || empty( $ut_csection_video_poster ) ) {
                    ...
                    if( !empty( $ut_csection_background_color ) ) {
                        echo '#contact-section .section-header.pt-style-1 .section-title span { background-color: ' . $ut_csection_background_color . '; }'. "\n"; 
                    }
                ...
                echo !empty( $ut_csection_header_padding_bottom ) ? '#contact-section .parallax-header, #contact-section .section-header { padding-bottom: ' . $ut_csection_header_padding_bottom . '; }' : '';   
                ...
                if( $ut_csection_overlay == 'on' ) {
                    ...
                    echo '#contact-section .parallax-overlay { padding-top:' . $ut_csection_padding_top . '; padding-bottom:' . $ut_csection_padding_bottom . '; }';                        
                    
                } else {
                    
                    echo '#contact-section { padding-top:' . $ut_csection_padding_top . '; padding-bottom:' . $ut_csection_padding_bottom . '; }';
