    ...
    class UT_Menu_Extensions {
        ...
        public function megamenu_meta_box() {
            ...
            echo '<div id="ut-mm-parent-for-menu" class="ut-mega-menu-setting">';
                ...
                echo '<h4>' , esc_html( 'Mega Menu', 'unite' ) , '</h4>';
                    ...
                    echo '<p class="button-controls">';
                        echo '<button data-menu-id="' , $_nav_menu_placeholder , '" type="button" name="add-mm-menu-item" id="add-mm-to-menu" class="ut-backend-button ut-megamenu-button ut-button-full">' , esc_attr_e('Add Mega Menu', 'unite') , '</button>';
                    echo '</p>';                
            ...
            echo '<div id="ut-mm-column-for-menu" class="ut-mega-menu-setting">';
                ...
                echo '<p class="button-controls">';
                    echo '<button data-menu-id="' , $_nav_menu_placeholder , '" type="button" name="add-mm-menu-item" id="add-mm-column-to-menu" class="ut-backend-button ut-megamenu-column-button ut-button-full">' , esc_attr_e('Add Column', 'unite') , '</button>';
                echo '</p>';                     
