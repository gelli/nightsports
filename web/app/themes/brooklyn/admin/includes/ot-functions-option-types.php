    ...
    function ot_type_button_builder( $args = array() ) {
        ...
        echo '<div class="ut-button-builder">';
            ...
            echo '<div class="ut-minicolors-wrap">';
              ...
              echo '<input maxlength="7" type="text" name="' . esc_attr( $field_name ) . '[color]" id="' . esc_attr( $field_id ) . '_color" value="' . ( isset( $field_value['color'] ) ? esc_attr( $field_value['color'] ) : '' ) . '" class="ut-ui-form-input ut-minicolors ' . esc_attr( $field_class ) . '" autocomplete="off" />';
            ...
            echo '<div class="ut-minicolors-wrap">';
              ...
              echo '<input maxlength="7" type="text" name="' . esc_attr( $field_name ) . '[hover_color]" id="' . esc_attr( $field_id ) . '_hover_color" value="' . ( isset( $field_value['hover_color'] ) ? esc_attr( $field_value['hover_color'] ) : '' ) . '" class="ut-ui-form-input ut-minicolors ' . esc_attr( $field_class ) . '" autocomplete="off" />';
            ...
            echo '<div class="ut-minicolors-wrap">';
              ...
              echo '<input maxlength="7" type="text" name="' . esc_attr( $field_name ) . '[text_color]" id="' . esc_attr( $field_id ) . '_text_color" value="' . ( isset( $field_value['text_color'] ) ? esc_attr( $field_value['text_color'] ) : '' ) . '" class="ut-ui-form-input ut-minicolors ' . esc_attr( $field_class ) . '" autocomplete="off" />';
            ...
            echo '<div class="ut-minicolors-wrap">';
              ...
              echo '<input maxlength="7" type="text" name="' . esc_attr( $field_name ) . '[text_hover_color]" id="' . esc_attr( $field_id ) . '_text_hover_color" value="' . ( isset( $field_value['text_hover_color'] ) ? esc_attr( $field_value['text_hover_color'] ) : '' ) . '" class="ut-ui-form-input ut-minicolors ' . esc_attr( $field_class ) . '" autocomplete="off" />';
            ...
            echo '<div class="ut-numeric-slider-outer-wrap">';
                ...
                echo '<div class="ut-numeric-slider-wrap">';
                    ...
                    echo '<input min="0" max="50" type="input" class="ut-ui-form-input ut-numeric-slider-helper-input" data-tooltip="' . esc_html( 'Max Value:', 'unitedthemes' ) . ' 50" value="' . ( isset( $field_value['border_radius'] ) ? esc_attr( $field_value['border_radius'] ) : '' ) . '" autocomplete="off">';
            ...
            echo '<div class="ut-minicolors-wrap">';
              ...
              echo '<input maxlength="7" type="text" name="' . esc_attr( $field_name ) . '[border_color]" id="' . esc_attr( $field_id ) . '_border_color" value="' . ( isset( $field_value['border_color'] ) ? esc_attr( $field_value['border_color'] ) : '' ) . '" class="ut-ui-form-input ut-minicolors ' . esc_attr( $field_class ) . '" autocomplete="off" />';
            ...
            echo '<div class="ut-minicolors-wrap">';
              ...
              echo '<input maxlength="7" type="text" name="' . esc_attr( $field_name ) . '[border_hover_color]" id="' . esc_attr( $field_id ) . '_border_hover_color" value="' . ( isset( $field_value['border_hover_color'] ) ? esc_attr( $field_value['border_hover_color'] ) : '' ) . '" class="ut-ui-form-input ut-minicolors ' . esc_attr( $field_class ) . '" autocomplete="off" />';
            ...
            if( function_exists('ut_recognized_icons') ) {
                ...
                echo '<div class="ut-iconpicker-wrap">';
                    ...
                    echo '<select class="ut-ui-form-select ut-icon-select" id="' , esc_attr( $field_id ) , '_icon" name="' , esc_attr( $field_name ) , '[icon]">';
                        ...
                        $field_value = !empty( $field_value['icon'] ) ? $field_value['icon'] : '';
...
if( ! function_exists( 'ot_type_numeric_slider' ) ) {
    ...
    function ot_type_numeric_slider( $args = array() ) {
        ...
        echo '<div class="ut-numeric-slider-wrap ' . $field_class . '">';
            ...
            echo '<input min="' . esc_attr( $min ) . '" max="' . esc_attr( $max ) . '" type="input" class="ut-ui-form-input ut-numeric-slider-helper-input" data-tooltip="' . esc_html( 'Max Value:', 'unitedthemes' ) . ' ' . esc_attr( $max ) . '" value="' . esc_attr( $field_value ) . '" autocomplete="off">';
...
if ( ! function_exists( 'ot_type_select_group' ) ) {
    ...
    function ot_type_select_group( $args = array() ) {
        ...
        echo '<div class="ut-ui-select-field">';
            ...
            /* build select */
            echo '<select name="' . esc_attr( $field_name ) . '" id="' . esc_attr( $field_id ) . '" class="ut-ui-form-select ut-ui-select ut-ui-group-select ' . esc_attr( $field_class ) . ' ' . ( isset($field_toplevel) && $field_toplevel ? 'ut-toplevel-select-option' : '' ) . '">';
