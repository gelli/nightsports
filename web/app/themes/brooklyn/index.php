...
<?php /* start output for classic blog , search , category tag or archive page */ ?>
    ...
    <div class="grid-container">
        ...
        <?php $grid = is_active_sidebar('blog-widget-area') && apply_filters( 'ut_show_sidebar', true ) ? 'grid-75 tablet-grid-75 mobile-grid-100' : 'grid-100 tablet-grid-100 mobile-grid-100'; ?>
